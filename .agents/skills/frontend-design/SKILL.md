...
description: Create distinctive, intentional frontend designs through aesthetic direction, typography, layout, and interface copy. Use when building new UI, redesigning an existing screen, or asking for visual design guidance.
license: Complete terms in references/LICENSE.txt
metadata:
  upstream: anthropics/skills frontend-design
  modifications: Description, typography, formatting, and license path normalized for this repository.
---
...
5. template chrome that appears whatever the subject: a tracked-out ALL-CAPS eyebrow label above every heading; meta strings joined with middle dots ('A · B · C'); labels built as 'WORD – fragment' used as a generic label; tinted near-black (#0B0B0B, #111) standing in for black; a monospace face for small data labels; a '→' appended to link and button text.
